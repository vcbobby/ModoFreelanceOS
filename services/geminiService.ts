...
export const generateProposals = async (
    ...
    try {
        ...
        switch (platform) {
          ...
          - Ofrece un plan de accion claro, especificando punto por punto como el freelancer propone realizar el proyecto y que se ajuste a lo que el cliente necesita para realizar su proyecto.
