            ...
            <div className="text-center space-y-6">
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-xl border border-green-200 dark:border-green-800">
                ...
                <p className="text-sm text-green-700 dark:text-green-400">
                  Tienes acceso ilimitado a todas las herramientas de IA.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <Button
                  onClick={() => window.open(GUMROAD_MANAGE_URL, '_blank')}
            ...
            <>
              <div className="text-center mb-8">
                ...
                <div className="inline-flex items-center gap-1 bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide mt-2">
                  <Infinity className="w-3 h-3" /> Acceso Total
                </div>
              </div>

              <ul className="space-y-4 mb-8">
                <BenefitItem text="Créditos ILIMITADOS en todas las herramientas." highlighted />
                <BenefitItem text="Crea tus portafolios y gestiona tus proyectos." highlighted />
                <li className="list-none">
                  <Button
                    ...
                    onClick={onSubscribe}
                  >
                    <Zap className="w-5 h-5 mr-2 fill-current" /> Pago automático con Gumroad
                  </Button>
                </li>
              ...
              <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-700">
                <div className="flex items-center justify-center gap-2 mb-6">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-2 whitespace-nowrap">
                    O elige un paquete de créditos
                  </span>
                  <div className="h-px bg-slate-200 dark:bg-slate-700 flex-1"></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {CREDIT_PACKAGES.map((pkg) => (
                    <CreditPackageCard key={pkg.credits} {...pkg} />
                  ))}
                </div>
