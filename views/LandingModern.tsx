    ...
    <div className="bg-slate-900 border border-slate-700 rounded-xl p-4 w-full max-w-sm shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-3 animate-pulse">
            ...
            <div className="h-20 bg-brand-900/20 border border-brand-500/30 rounded p-3 text-xs text-brand-200">
                <span className="text-brand-400 font-bold">IA:</span> Generando
                propuesta persuasiva para Upwork...
            </div>
...
const MockFinance = () => (
    <div className="bg-white text-slate-900 rounded-xl p-4 shadow-xl w-full max-w-sm relative">
        ...
        <div className="flex gap-2">
            ...
            <div className="flex-1 bg-brand-600 h-8 rounded text-white flex items-center justify-center text-xs font-bold">
                Ver Reporte
            </div>
        </div>
    </div>
...
export const LandingModern: React.FC = () => {
    useEffect(() => {
        ...
        document.title =
            'ModoFreelanceOS | El Sistema Operativo Todo-en-Uno para Freelancers'
        const metaDesc = document.querySelector('meta[name="description"]')
        if (metaDesc)
            metaDesc.setAttribute(
                'content',
                'Automatiza tu vida freelance. Genera propuestas con IA, gestiona finanzas, crea tu web profesional y encuentra trabajo en un solo lugar.'
            )
    }, [])
        ...
        <div className="min-h-screen bg-black text-white font-sans selection:bg-brand-500 selection:text-white overflow-x-hidden">
            ...
            <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-lg border-b border-white/10">
                <div className="container mx-auto px-6 h-16 flex justify-between items-center">
                    ...
                    <div className="flex gap-4">
                        <Button
                            onClick={handleLogin}
                            className="bg-white text-black hover:bg-slate-200 font-bold px-6"
                        >
                            Entrar
                        </Button>
                    </div>
                ...
                <div className="container mx-auto text-center max-w-5xl">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-bold text-brand-300 mb-8 uppercase tracking-wide hover:bg-white/10 transition-colors cursor-default">
                            ...
                            v1.3.0 Disponible Ahora
                        </div>

                        <h1 className="text-6xl md:text-8xl font-black mb-8 leading-tight tracking-tight">
                            Tu carrera freelance,
                            <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-400 via-green-400 to-emerald-600">
                                en Autopiloto.
                            </span>
                        </h1>
                        ...
                        <p className="text-xl md:text-2xl text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed">
                            ...
                            nuestra <strong>Inteligencia Artificial</strong>{' '}
                            para conseguir clientes, crear contratos, gestionar
                            tu dinero y construir tu marca personal.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Button
                                onClick={handleLogin}
                                className="h-14 px-10 text-lg bg-brand-600 hover:bg-brand-500 shadow-[0_0_40px_-10px_rgba(34,197,94,0.5)] border border-brand-400/50"
                            >
                                Comenzar Gratis{' '}
                            ...
                            <a
                                href="#video"
                                className="flex items-center justify-center gap-2 h-14 px-10 text-lg font-bold border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
                            >
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-slate-400">
                            Una suite completa de herramientas diseñadas para
                            facturar más.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[400px]">
                        ...
                        <motion.div
                            ...
                            className="md:col-span-2 bg-slate-900 border border-slate-800 rounded-3xl p-10 relative overflow-hidden group"
                        >
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-400 max-w-md">
                                    No escribas más cartas desde cero. Nuestra
                                    IA analiza la oferta de trabajo y redacta
                                    una propuesta ganadora para Upwork o Workana
                                    en segundos.
                                </p>
                            </div>
                        ...
                        <motion.div
                            ...
                            className="bg-slate-900 border border-slate-800 rounded-3xl p-10 relative overflow-hidden group"
                        >
                            ...
                            <p className="text-slate-400 text-sm mb-6">
                                Controla ingresos, gastos y suscripciones. Sabe
                        ...
                        <motion.div
                            ...
                            className="bg-slate-900 border border-slate-800 rounded-3xl p-10 relative overflow-hidden flex flex-col justify-between group"
                        >
                            <div>
                                ...
                                <p className="text-slate-400 text-sm">
                                    Crea tu portafolio profesional con dominio
                        ...
                        <motion.div
                            ...
                            className="md:col-span-2 bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-800 rounded-3xl p-10 relative overflow-hidden"
                        >
            ...
            >
                ...
                <div className="container mx-auto max-w-4xl text-center relative z-10">
                    ...
                    <p className="text-xl text-slate-300 mb-12">
                        Únete a la nueva generación de freelancers que usan IA
                        para trabajar menos y ganar más.
                    </p>

                    <div className="flex flex-col md:flex-row justify-center gap-6">
                        <a
                            href={ANDROID_LINK}
                            className="flex items-center gap-4 bg-white text-black p-4 rounded-xl hover:bg-slate-200 transition-all hover:scale-105 shadow-xl w-full md:w-auto justify-center md:justify-start"
                        >
                        ...
                        <a
                            href={WINDOWS_LINK}
                            className="flex items-center gap-4 bg-slate-800 text-white border border-slate-700 p-4 rounded-xl hover:bg-slate-700 transition-all hover:scale-105 shadow-xl w-full md:w-auto justify-center md:justify-start"
                        >
            ...
            <footer className="py-12 border-t border-white/10 bg-black text-sm text-slate-500">
                <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div>
                        &copy; 2026 ModoFreelanceOS. Hecho con ❤️ para la
                        comunidad.
                    </div>
