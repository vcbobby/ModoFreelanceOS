    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative overflow-hidden">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-900">Desbloquea ModoFreelanceOS Pro</h2>
          <p className="text-slate-600 mt-2">Gana tu próximo proyecto por menos de lo que cuesta una pizza.</p>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl p-4 mb-6 border border-slate-100">
          ...
          <p className="text-center text-sm text-slate-500 mt-1">Cancela cuando quieras.</p>
        </div>
        ...
        <Button variant="primary" className="w-full text-lg py-3" onClick={onSubscribe}>
          Suscribirme Ahora
        </Button>
        <button onClick={onClose} className="w-full mt-3 text-sm text-slate-400 hover:text-slate-600">
          Quizás más tarde
        </button>
      </div>
    </div>
